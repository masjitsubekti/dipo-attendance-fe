  ...
  <div class="w-full max-w-full overflow-x-hidden space-y-6 pb-12 animate-fade-in">
    ...
    <UiCard class="relative z-20" :padding="true">
      ...
      <div class="relative z-10 flex flex-col gap-5">
        ...
        <div class="pt-4 border-t border-slate-100 dark:border-slate-700/60 flex flex-wrap items-center justify-between gap-4">
          <div class="flex flex-wrap items-center gap-3 flex-1 min-w-0">
            <!-- Filter Unit Sekolah (UiAutocomplete) -->
            <div class="w-52 relative z-30">
              <UiAutocomplete
            ...
            <!-- Filter Tahun Ajaran & Semester (UiAutocomplete) -->
            <div class="w-64 relative z-30">
              <UiAutocomplete
            ...
            <!-- Filter Periode (UiAutocomplete) -->
            <div class="w-44 relative z-30">
              <UiAutocomplete
      ...
      <UiCard class="flex flex-col justify-between" :padding="true">
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            <UiBadge variant="secondary" class="text-xs">Hari Ini</UiBadge>
          </div>
...
useHead({
  title: "Executive Dashboard Superadmin",
});
